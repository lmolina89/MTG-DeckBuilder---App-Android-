...
public class Converter {
    ...
    public List<Card> convertSingleCardIntoFormatedCard(List<SingleCardInfo> singleCardInfoList) {
        ...
        singleCardInfoList.forEach(c -> {
            ...
            formatedCardList.add(new Card(c.getName(), c.getManaCost(), String.valueOf(Math.round(c.getCmc())), atributes, c.getOracleText(), c.getArtist(), c.getSetName(), image, c.getId()));
        });
